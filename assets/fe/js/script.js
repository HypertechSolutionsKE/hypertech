(function($) {
	...
	if( soonURL >= 0 || loginURL >= 0 || intro >= 0){
		...
		$('#sel_color').spectrum({
		    ...
		    selectionPalette: ["#1828ff", "#ed79e9", "#bf3404", "#880590", "#19e1ff", "#b90000", "#188283", "#da54e2", "#cac302", "#329900", "#00cdf2", "#fa1111", "#337AC1"]
		});
		...
		$('.reset-s').on("click",function(e){ 
			...
			$.cookie("theme", '.Main .light', { path: '/' });
			$('#changeCol').html('');
			$.cookie("mainCol", "#337AC1" , {path: '/'});
			$.cookie("darkerCol", "#0059B2" , {path: '/'});
